...
class DgCoreClient:
    ...
    async def get_active_character(self, game_id: str, user_id: str) -> dict[str, Any]:
        return await self._request(
            "GET",
            f"/api/bot/games/{game_id}/characters/active",
    ...
    async def list_characters(self, game_id: str, user_id: str) -> list[dict[str, Any]]:
        data = await self._request(
            "GET",
            f"/api/bot/games/{game_id}/characters",
            params={"user_id": user_id},
        )
    ...
    async def switch_character(
        ...
        return await self._request(
            ...
            json={"user_id": user_id, "patient_id": patient_id},
        )
    ...
    async def set_attribute(
        ...
        return await self._request(
            "PUT",
            f"/api/bot/games/{game_id}/characters/attributes",
            json={"user_id": user_id, "ghost_id": ghost_id, "attribute": attr, "value": value},
        )
    ...
    async def delete_character(
        ...
        return await self._request(
            "DELETE",
            f"/api/bot/games/{game_id}/characters/{patient_id}",
            params={"user_id": user_id},
        )
    ...
    async def create_patient(
        ...
        *,
        ...
        return await self._request("POST", "/api/admin/characters/patient", json=payload)
    ...
    async def create_ghost(
        ...
        *,
        ...
        if hp is not None:
            payload["hp"] = hp
        return await self._request("POST", "/api/admin/characters/ghost", json=payload)
    ...
    async def assign_companion(
        ...
        return await self._request(
            "PUT",
            f"/api/admin/characters/ghost/{ghost_id}/assign-companion",
            json={"game_id": game_id, "patient_id": patient_id, "user_id": user_id},
        )

    async def get_abilities(self, ghost_id: str) -> list[dict[str, Any]]:
        data = await self._request("GET", f"/api/bot/ghosts/{ghost_id}/abilities")
        if isinstance(data, list):
            return data
    ...
    async def submit_event(
        ...
        return await self._request("POST", "/api/bot/events", json=body)
    ...
    async def define_event(
        ...
        *,
        ...
        if color_restriction:
            payload["color_restriction"] = color_restriction.upper()
        if user_id:
            payload["user_id"] = user_id
        return await self._request(
            "POST", f"/api/bot/sessions/{session_id}/events/define", json=payload
        )

    async def list_events(self, session_id: str) -> list[dict[str, Any]]:
        data = await self._request("GET", f"/api/bot/sessions/{session_id}/events")
        if isinstance(data, list):
            return data
        return data.get("events", [])

    async def delete_event(
        self, session_id: str, event_id: str, *, user_id: str = ""
    ) -> dict[str, Any]:
        return await self._request(
            "DELETE",
            f"/api/bot/sessions/{session_id}/events/{event_id}",
    ...
    async def pause_session(self, session_id: str, *, user_id: str = "") -> dict[str, Any]:
        return await self._request(
            "POST",
            f"/api/bot/sessions/{session_id}/pause",
    ...
    async def resume_session(self, session_id: str, *, user_id: str = "") -> dict[str, Any]:
        return await self._request(
            "POST",
            f"/api/bot/sessions/{session_id}/resume",
            json={"user_id": user_id} if user_id else None,
        )

    async def get_session_info(self, session_id: str) -> dict[str, Any]:
        return await self._request("GET", f"/api/bot/sessions/{session_id}/info")
    ...
    async def add_session_player(
        ...
        if user_id:
            payload["user_id"] = user_id
        return await self._request(
            "POST", f"/api/bot/sessions/{session_id}/players", json=payload
        )
    ...
    async def remove_session_player(
        ...
        return await self._request(
            "DELETE",
            f"/api/bot/sessions/{session_id}/players/{patient_id}",
            params={"user_id": user_id} if user_id else None,
        )
    ...
    async def add_buff(
        ...
        *,
        ...
        if user_id:
            payload["user_id"] = user_id
        return await self._request(
            "POST", f"/api/bot/games/{game_id}/buffs", json=payload
        )

    async def list_buffs(self, game_id: str, ghost_id: str) -> list[dict[str, Any]]:
        data = await self._request(
            "GET", f"/api/bot/games/{game_id}/ghosts/{ghost_id}/buffs"
        )
        if isinstance(data, list):
            return data
    ...
    async def remove_buff(
        ...
        return await self._request(
            "DELETE",
            f"/api/bot/games/{game_id}/buffs/{buff_id}",
            params={"user_id": user_id} if user_id else None,
        )
    ...
    async def create_item_definition(
        ...
        *,
        ...
        if user_id:
            payload["user_id"] = user_id
        return await self._request(
            "POST", f"/api/bot/games/{game_id}/items/definitions", json=payload
        )

    async def list_item_definitions(self, game_id: str) -> list[dict[str, Any]]:
        data = await self._request(
            "GET", f"/api/bot/games/{game_id}/items/definitions"
        )
        if isinstance(data, list):
            return data
    ...
    async def grant_item(
        ...
        *,
        ...
        return await self._request(
            "POST",
            f"/api/bot/games/{game_id}/items/grant",
            json={
                "user_id": user_id,
    ...
    async def get_inventory(self, game_id: str, user_id: str) -> list[dict[str, Any]]:
        data = await self._request(
            "GET",
            f"/api/bot/games/{game_id}/items/inventory",
            params={"user_id": user_id},
        )
        if isinstance(data, list):
            return data
    ...
    async def roll_dice(
        ...
        *,
        ...
        if user_id:
            payload["user_id"] = user_id
        return await self._request("POST", "/api/bot/roll", json=payload)
    ...
    async def create_region(
        ...
        if user_id:
            payload["user_id"] = user_id
        return await self._request(
            "POST", f"/api/admin/games/{game_id}/regions", json=payload
        )

    async def list_regions(self, game_id: str) -> list[dict[str, Any]]:
        data = await self._request("GET", f"/api/admin/games/{game_id}/regions")
        if isinstance(data, list):
            return data
    ...
    async def create_location(
        ...
        *,
        ...
        if user_id:
            payload["user_id"] = user_id
        return await self._request(
            "POST", f"/api/admin/regions/{region_id}/locations", json=payload
        )

    async def list_locations(self, region_id: str) -> list[dict[str, Any]]:
        data = await self._request("GET", f"/api/admin/regions/{region_id}/locations")
        if isinstance(data, list):
            return data
        return data.get("locations", [])

    async def get_location_players(self, location_id: str) -> list[dict[str, Any]]:
        data = await self._request("GET", f"/api/bot/locations/{location_id}/players")
        if isinstance(data, list):
            return data
    ...
    async def list_pending_comms(
        ...
        data = await self._request(
            "GET",
            f"/api/bot/games/{game_id}/communications/pending",
            params={"user_id": user_id},
        )
        if isinstance(data, list):
            return data
    ...
    async def get_session_timeline(
        ...
        if count is not None:
            params["count"] = count
        data = await self._request(
            "GET", f"/api/bot/sessions/{session_id}/timeline", params=params or None
        )
        if isinstance(data, list):
            return data
    ...
    async def get_game_timeline(
        self, game_id: str, *, count: int | None = None
    ) -> list[dict[str, Any]]:
        params: dict[str, Any] = {}
        if count is not None:
            params["count"] = count
        data = await self._request(
            "GET", f"/api/bot/games/{game_id}/timeline", params=params or None
        )
        if isinstance(data, list):
            return data
        return data.get("entries", data.get("events", []))
    ...
    async def get_game_info(self, game_id: str) -> dict[str, Any]:
        return await self._request("GET", f"/api/bot/games/{game_id}")
    ...
    async def update_game_player_role(
        ...
        return await self._request(
            "PUT",
            f"/api/admin/games/{game_id}/players/{user_id}/role",
            json={"role": role},
        )
